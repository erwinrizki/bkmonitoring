    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<?php 		
			...
			echo form_open('mapel/add_mapel', $form);
		?>
		...
		<tr>
			...
			<td>:</td>
			<td><input name="kode" type="text" id="kode" size="30" required="required"/></td>
		</tr>
		<tr>
			<td>Nama Mapel</td>
			<td>:</td>
		...
		<tr>
			<td>KKM Mapel</td>
			<td>:</td>
			<td><input name="kkm" type="number" max="100" min="0" id="nama_depan" size="30" required="required"/></td>
		</tr>
		<tr>
			<td colspan="3">
