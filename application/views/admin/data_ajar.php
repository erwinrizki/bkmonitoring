    ...
    <div class="container">
      ...
      <div class="hero-unit">
		<h3>Data Mengajar Guru</h3><br/><br/>
			<!-- <a href="<?php //echo base_url(); ?>ajar/tambah_ajar"><img src="<?php //echo base_url() ?>public/images/add.png" title="Tambah Data Ajar" />Tambah Data Ajar</a><br/><br/> -->
			<a class="btn btn-success" href="<?php echo base_url(); ?>ajar/tambah_ajar"><i class="icon-plus"></i> Tambah Data Ajar</a><br/><br/>
			<table class="table table-striped" >
				...
				<?php
					...
					foreach($ajar as $ajara) {
						$id = $ajara->id_ajar;
						$guru = $ajara->nama_guru;
						$nama = $ajara->nama_mapel;
						$kelas = $ajara->nama_kelas;
				...
				?>
						<tr>
							...
							<td><?php echo $nama ?></td>
							<td>
								<a href="<?php echo $url ?>ajar/edit_ajar/<?php echo $id ?>" title="Edit Data Ajar"><img src="<?php echo $url ?>public/images/update.png" width="40" height="40" /></a>
								<a href="<?php echo $url ?>ajar/hapus_ajar/<?php echo $id ?>" title="Hapus Data Ajar" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?');"><img src="<?php echo $url ?>public/images/delete.png" width="40" height="40" /></a>
							</td>
						</tr>
				<?php
						$no++;
