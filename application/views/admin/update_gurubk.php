    ...
    <div class="container">
      ...
      <div class="hero-unit">
        ...
        <?php 
			...
			echo form_open('gurubk/update_guru');
		?>
		<?php 
			foreach($guru as $gurua) {
				...
				$tempat = $gurua->tempat_lahir_bk;
				$tgl = $gurua->tanggal_lahir_bk;
				$pass = $gurua->password;
			}
		?>
		<center>
		...
		<tbody>
		<tr>
			<td class="span2">NIP Guru</td>
			<td>:</td>
			<td>
				<input name="nip" value="<?php echo $nip ?>" type="text" id="induk" size="30" required="required"/>
		...
		<tr>
			<td>Tanggal Lahir</td>
			<td>:</td>
			<td><input type="text" value="<?php echo $tgl ?>" id="tanggal" name="tanggal" required="required"></td>
		</tr>
		<tr>
			<td>Password</td>
			<td>:</td>
			<td><input name="pass" value="<?php echo $pass ?>" type="text" id="ortu" size="60" required="required"/></td>
		</tr>
		<tr>
			<td colspan="3">
				<center>
