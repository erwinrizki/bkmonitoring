...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  ...
	  ?>
      <div class="hero-unit">
		<h3>Data Guru BK</h3><br/><br/>
			<!-- <a href="<?php //echo base_url(); ?>gurubk/tambah_guru"><img src="<?php //echo base_url() ?>public/images/add.png" title="Tambah Guru BK" />Tambah Guru BK</a><br/><br/> -->
			<a class="btn btn-success" href="<?php echo base_url(); ?>gurubk/tambah_guru"><i class="icon-plus"></i> Tambah Guru BK</a><br/><br/>
			<table class="table table-striped" >
				...
				?>
						<tr>
							...
							<td><?php echo $pass ?></td>
							<td>
								<a href="<?php echo $url ?>gurubk/edit_guru/<?php echo $gurua->id_bk ?>" title="Edit Guru"><img src="<?php echo $url ?>public/images/update.png" width="40" height="40" /></a>
								<a href="<?php echo $url ?>gurubk/hapus_guru/<?php echo $gurua->id_bk ?>" title="Hapus Guru" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?');" ><img src="<?php echo $url ?>public/images/delete.png" width="40" height="40" /></a>
							</td>
						</tr>
				<?php
						$no++;
