		...
		<div class="navbar navbar-default navbar-fixed-top">
		  ...
		  <div class="navbar-collapse collapse navbar-responsive-collapse">
			<ul class="nav navbar-nav">
			  <li><a href="<?php echo base_url() ?>simn/panel_waka">Home</a></li>
		...
		<div class="container">
			...
			<div class="jumbotron">
				...
				<?php 		
					...
					echo form_open('nilai/cari_siswa_waka', $form);
				?>
				...
				?>
						<tr>
							...
							<td><?php echo $hp ?></td>
							<td>
								<a class="btn btn-success" href="<?php echo base_url(); ?>nilai/lihat_grafik_nilai_siswa_waka/<?php echo $idsiswa ?>">Lihat Nilai</a><br/><br/>
							</td>
						</tr>
				<?php
						$no++;
