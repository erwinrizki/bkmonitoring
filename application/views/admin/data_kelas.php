...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  ...
	  ?>
      <div class="hero-unit">
		<h3>Data Kelas</h3><br/><br/>
			<!-- <a href="<?php //echo base_url(); ?>kelas/tambah_kelas"><img src="<?php //echo base_url() ?>public/images/add.png" title="Tambah Kelas" />Tambah Kelas</a><br/><br/> -->
			<a class="btn btn-success" href="<?php echo base_url(); ?>kelas/tambah_kelas"><i class="icon-plus"></i> Tambah Kelas</a><br/><br/>
			<table class="table table-striped" >
				...
				?>
						<tr>
							...
							<td><?php echo $nama ?></td>
							<td>
								<a href="<?php echo $url ?>kelas/edit_kelas/<?php echo $kelasa->id_kelas ?>" title="Edit Kelas"><img src="<?php echo $url ?>public/images/update.png" width="40" height="40" /></a>
								<a href="<?php echo $url ?>kelas/hapus_kelas/<?php echo $kelasa->id_kelas ?>" title="Hapus Kelas" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?');" ><img src="<?php echo $url ?>public/images/delete.png" width="40" height="40" /></a>
							</td>
						</tr>
				<?php
						$no++;
