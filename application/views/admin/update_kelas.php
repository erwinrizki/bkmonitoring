    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<?php 		
			...
			echo form_open('kelas/update_kelas', $form);
		?>
		...
		?>
		<tr>
			<td class="span2">Nama Kelas</td>
			<td>:</td>
			<td>
				<input name="nama" type="text" value="<?php echo $nama ?>" id="nama_depan" size="30" required="required"/>
