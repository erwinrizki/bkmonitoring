  ...
  <body>
		...
		<div class="container">
			<div class="jumbotron">
				...
				<div class="row">
				<div class="span3">
					<a href="<?php echo base_url(); ?>nilai/lihat_nilai_siswa"><img src="<?php echo base_url() ?>public/images/grafik.png" title="Lihat Nilai Siswa" /></a><br/><br/>
					<a class="btn btn-primary btn-lg" href="<?php echo base_url(); ?>nilai/lihat_nilai_siswa">Lihat Nilai Siswa</a>
				</div>
				</div>
			</div>
