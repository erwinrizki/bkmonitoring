    ...
    <div class="container">
      ...
      <div class="hero-unit">
        ...
        <?php 
			...
			echo form_open('gurubk/add_guru');
		?>
		<center>
		...
		<tr>
			...
			<td>:</td>
			<td><input name="nip" type="text" id="induk" size="30" required="required"/></td>
		</tr>
		<tr>
			<td>Nama Guru</td>
			<td>:</td>
		...
		<tr>
			<td>Password</td>
			<td>:</td>
			<td><input name="pass" type="text" id="ortu" size="60" required="required"/></td>
		</tr>
		<tr>
			<td colspan="3">
				<center>
